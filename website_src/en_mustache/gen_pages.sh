...
mustach $CONF_DIR/config_exam.json quest_creator_resu.mustache > $DEST_DIR/quest_creator_resu.html
mustach $CONF_DIR/config_exam.json quest_old.mustache > $DEST_DIR/quest_old.html
