...
function init_en_exam_msg(){
	...
	*/
	...
	lg.q12_1__sleep = `Select all verses that support that dead people do NOT have consciousness until resurrected. (` + get_dispute_msg() + ")";
	...
	lg.q12_1__verse2_href = make_bible_ref(obj_1co_11_30);
	...
	lg.q12_1__verse6_str = uppercase_words_in_string(all_bibrefs.job_14_12_str, ["Until", "nor", "roused", "out", "sleep.", ]);
	lg.q12_1__verse6_href = all_bibrefs.job_14_12_href;
	lg.q12_1__verse6_should = "People will NOT be ROUSED OUT of their SLEEP UNTIL these heavens are no more";
	lg.q12_1__verse7_str = uppercase_words_in_string(all_bibrefs.psa_115_17_str, ["dead", "don’t", "praise", ]);
	lg.q12_1__verse7_href = all_bibrefs.psa_115_17_href;
	lg.q12_1__verse7_should = "DEAD people (NOT just bodies) do NOT PRAISE";	
	lg.q12_1__verse8_str = uppercase_words_in_string(all_bibrefs.jhn_5_28_str, ["are", "in", "tombs"]);
	lg.q12_1__verse8_href = all_bibrefs.jhn_5_28_href;
	lg.q12_1__verse8_should = "People who get resurrection ARE IN the TOMBS, the sepulcre, the hebrew Sheol, the poorly translated greek Hades, NOT in heaven or hell.";
