...
export function init_exam_database(){
	...
	db.THIS_MODULE_NAME = "module3";  // CAREFUL. Name of this module in firebase. OBLIGATORY FIELD.

	db.q_first_quest_mod_3__ = { 
		htm_stm: "q_first_quest_mod_3",
		answers: {
			a_simple_YES: {},
			a_simple_NO: {},
		},
	...
	db.q_second_quest_mod_3__ = { 
		htm_stm: "q_second_quest_mod_3",
		answers: {
			a_simple_YES: {},
			a_simple_NO: {},
		},
